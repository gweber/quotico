...
from app.services.event_handlers.odds_handlers import handle_odds_ingested, handle_odds_raw_ingested
...
def register_event_handlers(bus: InMemoryEventBus) -> None:
    ...
    if settings.EVENT_HANDLER_ODDS_INGESTED_ENABLED:
        ...
        bus.subscribe("odds.raw_ingested", handle_odds_raw_ingested, handler_name="odds_raw_ingested", concurrency=1)
